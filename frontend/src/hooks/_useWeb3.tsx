...
export const useWeb3 = () => {
  ...
  const [currentAccount, setCurrentAccount, clearLocalStorage] =
    useLocalStorage("@BF_DATA", initialState);
  ...
  useEffect(() => {
    const load = async () => {
      const MainContractAddress = "0x64e9df92f5810efc16ee280c9bafceb3eab95b60";
      const NFTContractAddress = "0xd72331afeb36d033cd0d9b4ecc1aa22d010fb5bf";
  ...
  useEffect(() => {
    ...
    if (ethereum) {
      ...
      ethereum.on("chainChanged", (chainId) => {
        chainId === "0x3" ? window.location.reload() : setChainError(true);
      });
